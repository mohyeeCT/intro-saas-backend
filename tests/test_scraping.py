...
from routers import intro
from utils import scraper


class IntroScrapingTests(unittest.TestCase):
    ...
    def test_primary_firecrawl_skips_jina(self):
        with patch.object(intro, "scrape_page_context") as jina, patch(
            "utils.scraper.scrape_page_context_firecrawl",
            return_value={"success": True, "source": "firecrawl"},
        ) as firecrawl:
            result = intro._scrape_page_for_settings(
                {
